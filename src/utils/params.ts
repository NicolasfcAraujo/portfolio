export const params = [
  [
    [375],
    [
      { gridColumnStart: 1, gridColumnEnd: 3, gridRowStart: 1, gridRowEnd: 4 },
      { gridColumnStart: 1, gridColumnEnd: 3, gridRowStart: 4, gridRowEnd: 7 },
      { gridColumnStart: 3, gridColumnEnd: 4, gridRowStart: 1, gridRowEnd: 3 },
      { gridColumnStart: 3, gridColumnEnd: 4, gridRowStart: 3, gridRowEnd: 5 },
      { gridColumnStart: 3, gridColumnEnd: 4, gridRowStart: 5, gridRowEnd: 7 },
      { gridColumnStart: 4, gridColumnEnd: 5, gridRowStart: 1, gridRowEnd: 5 },
